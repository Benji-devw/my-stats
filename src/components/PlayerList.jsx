...
const MatchList = ({ players }) => {
  ...
  return (
    <div className="player__list z-10 p-4 mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-5 lg:text-left">
      {players.map((player) => (
        <Link
          key={player.player_id}
          href={`/player/${player.player_id}`}
          className="player__list__link group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300"
          // target="_blank"
